...
* @version 3.0.0
/**
 * The Heartland Table — Cookbook PDF Builder v3
 * 
 * Embeds images as base64 to ensure they render in the PDF
 */
...
async function build() {
  console.log('🌾 Building The Heartland Table (v3 - with embedded images)...\n');
  ...
  try {
    ...
    console.log(`\n  📄 Generating PDF (this may take a minute with embedded images)...`);
